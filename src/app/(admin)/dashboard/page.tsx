        ...
        onclone: (clonedDoc) => {
          ...
          for (let i = 0; i < styleTags.length; i++) {
            ...
            if (style.innerHTML.match(/(lab|lch|okl)/i)) {
              style.innerHTML = style.innerHTML.replace(unsupportedColorDeclarationRegex, '$1rgb(255,255,255)$3');
            }
          }
          ...
          problematicElements.forEach((el: any) => {
            ...
            if (inlineCss) {
               el.setAttribute('style', inlineCss.replace(unsupportedColorDeclarationRegex, '$1rgb(255,255,255)$3'));
            }
          });
        }
      });
