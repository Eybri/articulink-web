      ...
      {loading ? (
        ...
        <ResponsiveContainer width="100%" height="100%">
          <ComposedChart data={data} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
            ...
            />
            <Bar dataKey="chat_count" name="Chat Activities" barSize={15} fill="#1A4480" radius={[4, 4, 0, 0]} />
            <Line type="monotone" dataKey="audio_count" name="Audio Sessions" stroke="#2A8FA0" strokeWidth={3} dot={{ r: 4, fill: '#2A8FA0', strokeWidth: 2, stroke: '#FFFFFF' }} activeDot={{ r: 6, strokeWidth: 0 }} />
          </ComposedChart>
        </ResponsiveContainer>
      )}
    </ChartContainer>
